...
public class ConstructorDeclarations extends ConstructorDeclList {

    private ConstructorDeclList ConstructorDeclList;
    private ConstructorDecl ConstructorDecl;

    public ConstructorDeclarations (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorDeclarations(\n");
