...
public class ProgVarDeclarations extends ProgDeclList {

    private ProgDeclList ProgDeclList;
    private VarDecl VarDecl;

    public ProgVarDeclarations (ProgDeclList ProgDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgVarDeclarations(\n");
